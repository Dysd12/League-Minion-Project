...
static void nRF24_print_registers(bool tx_mode) {
    ...
    printf("nRF24 SETUP_RETR:  0x%02X\n", val);
    nRF24_read(RF_CH, &val, 1);
    printf("nRF24 RF_CH:       0x%02X\n", val);
    nRF24_read(RF_SETUP, &val, 1);
    printf("nRF24 RF_SETUP:    0x%02X\n", val);
    nRF24_read(STATUS, &val, 1);
    printf("nRF24 STATUS:      0x%02X\n", val);
    nRF24_read(RX_ADDR_P0, addr, 5);
    printf("nRF24 RX_ADDR_P0:  0x%02X%02X%02X%02X%02X\n", addr[4], addr[3], addr[2], addr[1], addr[0]);
    nRF24_read(RX_ADDR_P1, addr, 5);
    printf("nRF24 RX_ADDR_P1:  0x%02X%02X%02X%02X%02X\n", addr[4], addr[3], addr[2], addr[1], addr[0]);
    nRF24_read(RX_ADDR_P2, addr, 5);
    printf("nRF24 RX_ADDR_P2:  0x%02X%02X%02X%02X%02X\n", addr[4], addr[3], addr[2], addr[1], addr[0]);
    nRF24_read(RX_ADDR_P3, addr, 5);
    printf("nRF24 RX_ADDR_P3:  0x%02X%02X%02X%02X%02X\n", addr[4], addr[3], addr[2], addr[1], addr[0]);
    nRF24_read(RX_ADDR_P4, addr, 5);
    printf("nRF24 RX_ADDR_P4:  0x%02X%02X%02X%02X%02X\n", addr[4], addr[3], addr[2], addr[1], addr[0]);
    nRF24_read(RX_ADDR_P5, addr, 5);
    printf("nRF24 RX_ADDR_P5:  0x%02X%02X%02X%02X%02X\n", addr[4], addr[3], addr[2], addr[1], addr[0]);
    nRF24_read(TX_ADDR, addr, 5);
    printf("nRF24 TX_ADDR:     0x%02X%02X%02X%02X%02X\n", addr[4], addr[3], addr[2], addr[1], addr[0]);
    nRF24_read(RX_PW_P0, &val, 1);
    printf("nRF24 RX_PW_P0:    0x%02X\n", val);
    nRF24_read(RX_PW_P1, &val, 1);
    printf("nRF24 RX_PW_P1:    0x%02X\n", val);
    nRF24_read(RX_PW_P2, &val, 1);
    printf("nRF24 RX_PW_P2:    0x%02X\n", val);
    nRF24_read(RX_PW_P3, &val, 1);
    printf("nRF24 RX_PW_P3:    0x%02X\n", val);
    nRF24_read(RX_PW_P4, &val, 1);
    printf("nRF24 RX_PW_P4:    0x%02X\n", val);
    nRF24_read(RX_PW_P5, &val, 1);
    printf("nRF24 RX_PW_P5:    0x%02X\n", val);
    nRF24_read(FIFO_STATUS, &val, 1);
    printf("nRF24 FIFO_STATUS: 0x%02X\n", val);
}
